...
label-asset-library-subtitle = Search the mounted game data, inspect sprites and audio, then copy the exact asset name for a presentation pack.
...
label-asset-library-presentation-hint = Building a presentation pack? Copy the selected asset name, return to Experience Builder, and use the pack-folder shortcut.
